(function registerPreviewWalletOverlay(globalObject) {
  ...
  class PreviewWalletOverlay {
    ...
    render() {
      ...
      const triggerLabel = isConnected ? "Connected" : "Disconnected";
      ...
      this.mount.root.innerHTML = `
        <div class="preview-wallet-shell">
          ...
          <div class="preview-wallet-trigger">
            <div class="preview-wallet-trigger-left">
              <div class="preview-wallet-status ${
                isConnected ? "connected" : ""
              }">${triggerLabel}</div>
              <div class="preview-wallet-name">Preview Wallet</div>
            </div>
