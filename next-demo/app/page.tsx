  ...
  return (
    <main className="page">
      ...
      <p className="lede">
        ...
        <code>@apexethdev/preview-wallet</code> package. The same package provides
      ...
      <div className="section">
        ...
        <p>
          ...
          wallet sidecar from <code>next-demo</code> in separate terminals.
        </p>
        <pre>
      ...
      <div className="section">
        ...
        <p>
          ...
          <code>@apexethdev/preview-wallet/react</code> and start the local server
